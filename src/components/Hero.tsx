  ...
  return (
    <section className="min-h-[80vh] flex flex-col justify-center items-center text-center px-4">
      <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-fade-down">
        Hi, I'm <span className=" text-cyan-600 hover:text-cyan-500 transition-colors cursor-default">Aadi Kommula</span>
      </h1>
      ...
      <div className="flex gap-4">
        <Button 
          size="lg" 
          className="group bg-transparent border  text-cyan-600 hover:text-white  animate-fade-up hover:bg-cyan-500 " 
        ...
        <Button 
          size="lg" 
          variant="outline" 
          className="group  text-cyan-600 hover:text-white  animate-fade-up hover:bg-cyan-500 " 
